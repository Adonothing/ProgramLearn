...
&emsp;&emsp;可是我们在这里直接在文件系统中删除这个大的文件，然后再次提交，会发现这个问题并未得到解决。原因在于我们并没有将上次的提交操作撤回。输入
...
```bash
8f4226f482da7fdb721d987210cf4ab53cf59544
```

键入q，退出编辑。撤回到之前版本的提交：

```bash
git reset --soft 8f4226f482da7fdb721d987210cf4ab53cf59544
```
